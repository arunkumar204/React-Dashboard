              ...
              <Table responsive hover className="recent-users">
                <tbody>
                  ...
                  <tr className="unread">
                    ...
                    <td>
                      <h6 className="mb-1">Abhi</h6>
                      <p className="m-0">Lorem Ipsum is simply dummy text of…</p>
                    </td>
                    <td>
                      <h6 className="text-muted">
                        <i className="fa fa-circle text-c-green f-10 m-r-15" />13 June 17:38
                      </h6>
                    </td>
                    <td>
                      <Link to="#" className="label theme-bg2 text-white f-12">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <p className="m-0">
                        Assigned to<span className="text-c-green"> Nithya</span>
                      </p>
                    </td>
                    <td>
                    ...
                    <td>
                      <h6 className="m-0">October 26, 2023</h6>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <p className="m-0">
                        Assigned to<span className="text-c-green"> Arun</span>
                      </p>
                    </td>
                    <td>
                    ...
                    <td>
                      <h6 className="m-0">September 4, 2023</h6>
                    </td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <p className="m-0">
                        Assigned to<span className="text-c-green"> Albert</span>
                      </p>
                    </td>
                    <td>
                    ...
                    <td>
                      <h6 className="m-0">March 14, 2024</h6>
                    </td>
                  </tr>
                  <tr>
                    <td>
                    ...
                    <td>
                      <h6 className="mb-1">Social Media App</h6>
                      <p className="m-0">
                        Assigned to<span className="text-c-green"> Abhi</span>
                      </p>
                    </td>
                    <td>
                    ...
                    <td>
                      <h6 className="m-0">May 14, 2024</h6>
                    </td>
                  </tr>
                </tbody>
              </Table>
